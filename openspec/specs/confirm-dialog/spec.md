...
Définir les exigences pour le composant React de dialogue de confirmation, utilisé avant toute action destructrice (suppression ou archivage) dans l'application Abos.
